  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <form onSubmit={addNewHabit} className="relative rounded-md p-2 mx-3 bg-zinc-800 border border-blue-600/30 shadow-blue-400/70 shadow-[inset_0_0_15px_rgba(59,130,246,0.4)]">
        ...
        <button type='button' className="text-blue-300 rounded-xs w-6 h-6 ml-7.5 absolute top-2 right-4  active:cursor-pointer hover:cursor-pointer " onClick={closeFunction}>✕</button>
